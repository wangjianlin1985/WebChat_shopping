...
public class ProductService {
    ...
    /*按照查询条件分页查询商品记录*/
    public ArrayList<Product> queryProduct(ProductClass productClassObj,String productName,String recommendFlag,String addTime,int currentPage) throws Exception { 
    	...
    	if(!recommendFlag.equals("")) where = where + " and t_product.recommendFlag like '%" + recommendFlag + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Product> queryProduct(ProductClass productClassObj,String productName,String recommendFlag,String addTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != productClassObj && productClassObj.getClassId()!= null && productClassObj.getClassId()!= 0)  where += " and t_product.productClassObj=" + productClassObj.getClassId();
    	if(!productName.equals("")) where = where + " and t_product.productName like '%" + productName + "%'";
    	if(!recommendFlag.equals("")) where = where + " and t_product.recommendFlag like '%" + recommendFlag + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(ProductClass productClassObj,String productName,String recommendFlag,String addTime) throws Exception {
     	String where = "where 1=1";
    	if(null != productClassObj && productClassObj.getClassId()!= null && productClassObj.getClassId()!= 0)  where += " and t_product.productClassObj=" + productClassObj.getClassId();
    	if(!productName.equals("")) where = where + " and t_product.productName like '%" + productName + "%'";
    	if(!recommendFlag.equals("")) where = where + " and t_product.recommendFlag like '%" + recommendFlag + "%'";
